...
public class BookControllerTest {
    ...
    private Book createOneBook(Long id) {
        ...
        Genre genre = Genre.builder()
                ...
                .build();
        return Book.builder()
                .id(id).title("book_name_1").genre(genre).author(author1).build();
    ...
    List<Book> createBookList() {
        ...
        return List.of(Book.builder()
                        .id(1).title("book_name_1").genre(genre).author(author1).build(),
                Book.builder()
                        .id(2).title("book_name_2").genre(genre).author(author2).build());
